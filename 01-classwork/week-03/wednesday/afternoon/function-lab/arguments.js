...
// ? Define a function "shout" that accepts three strings as parameters. It should return the strings joined together in all uppercase, with a space between each string eg 'hello', 'world' --> 'HELLO WORLD'
